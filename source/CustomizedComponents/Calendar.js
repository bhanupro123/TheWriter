...
import { ClearDataset } from './calendar/Day';

export default class CalendarPicker extends Component {
  onGotResponcedfromDaysGridView = null;
  thisprops = null
  constructor(props) {
    super(props);
    console.log(props.canGetResponse,props.yearsVisible ,"#####################################################")
  ...
  handleOnPressDay = ({ year, month, day }) => {
    ...
    this.handleOnPressFinisher({ year, month: month, scrollFinisher });
    const {
  ...
  handleOnPressYear = () => {
    // return
    if (this.thisprops.yearsVisible) {
      this.setState({
        currentView: 'years'
      });
    }
  ...
  renderMonth(props) {
    return (
      <DaysGridView onGotResponcedfromDaysGridView={(val, date) => {

        this.onGotResponcedfromDaysGridView(val, date)

      }} canGetResponse={this.thisprops.canGetResponse} {...props} global={this.props.global} onDayRef={this.props.onDayRef} prevProps={this.thisprops} />
    );
  }
  ...
  render() {
    ...
    this.onGotResponcedfromDaysGridView = onGotResponceof;

...
this.thisprops = props
  ...
  renderDayInCurrentMonth(day) {
    ...
    return ({
      ...
      component: (
        <Day  ref={(ref)=>{
           if(this.props.onDayRef)
           this.props.onDayRef(ref)
        }}

           
          onGotResponced={(val,date)=>{
            this.onGotResponcedfromDaysGridView(val,date) 
             }}
             canGetResponse = {this.thisprops.canGetResponse} prevProps = {this.thisprops}
          key={day}
          day={day}
  ...
  render() {
    const { styles,onGotResponcedfromDaysGridView } = this.props;
    this.onGotResponcedfromDaysGridView=onGotResponcedfromDaysGridView;
    const { daysGrid } = this.state;
   // onGotResponcedfromDaysGridView("")
...
DaysGridView.propTypes = {
  ...
  onGotResponce: PropTypes.func,
  canGetResponse:PropTypes.bool,
